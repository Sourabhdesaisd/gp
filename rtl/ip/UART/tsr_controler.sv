...
module tsr_controler #(
    ...
    input  logic             valid_1,       // 1 = 16-cycle baud, 0 = 13-cycle baud
    input  logic             sel,	
    // Break control
    ...
    output logic              tx_start, // HIGH while frame is being sent
...
logic start_point;
	assign start_point = sel ? baud_last&& valid_1 :valid_1;
    // =========================================================================
    // Next-state logic
    // =========================================================================
    always_comb begin
        ...
        if (bc) begin
            ...
            case (present_state)
                ...
                WAIT1:  if ( start_point)         next_state = START;
...
assign tx_start = (present_state == START) ? 1'b1 : 1'b0;
    ...
    always_comb begin
        if (bc) begin
            ...
            case (present_state)
                START:begin   tx_next = 1'b0;
		//	  tx_start = 1'b1;
			 end
                DATA: begin   tx_next = serial_out;
		//	  tx_start = 1'b0;
			end
