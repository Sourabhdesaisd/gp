module replace_1_port_itlb #(
    ...
    input  logic                           i_prefetch_hit ,
    input  logic [$clog2(TLB_ENTRIES)-1:0] i_prefetch_hit_index ,
    ...
    always_comb begin
        ...
        else if (i_prefetch_hit) begin
		    access_idx = i_prefetch_hit_index ;
		    do_update = 1'b1;
            end
