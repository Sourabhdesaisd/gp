//`timescale 1ns / 1ps
module soc_priority_resolve #(parameter BASE_INT_ID = 8'd16)
(
input               soc_clk                     ,
input               soc_rst                     ,
//input               wdt_reset_i                 ,
...
localparam IRQ_ID_0	    =	  BASE_INT_ID + 8'd0        ;	
localparam IRQ_ID_1	    =	  BASE_INT_ID + 8'd1        ;	
localparam IRQ_ID_2	    =	  BASE_INT_ID + 8'd2        ;	
localparam IRQ_ID_3	    =	  BASE_INT_ID + 8'd3        ;	
localparam IRQ_ID_4	    =	  BASE_INT_ID + 8'd4        ;	
localparam IRQ_ID_5	    =	  BASE_INT_ID + 8'd5        ;	
localparam IRQ_ID_6	    =	  BASE_INT_ID + 8'd6        ;	
localparam IRQ_ID_7	    =	  BASE_INT_ID + 8'd7        ;	
localparam IRQ_ID_8	    =	  BASE_INT_ID + 8'd8        ;	
localparam IRQ_ID_9	    =	  BASE_INT_ID + 8'd9        ;	
localparam IRQ_ID_10	=	  BASE_INT_ID + 8'd10       ;	
localparam IRQ_ID_11	=     BASE_INT_ID + 8'd11       ;
localparam IRQ_ID_12	=     BASE_INT_ID + 8'd12       ;
localparam IRQ_ID_13	=     BASE_INT_ID + 8'd13       ;
localparam IRQ_ID_14	=     BASE_INT_ID + 8'd14       ;
localparam IRQ_ID_15	=     BASE_INT_ID + 8'd15       ;
...
always @(*) begin
  ...
  if (val_in_1[7:0] > val_in_2[7:0]) begin
    val_out = val_in_1;
    out_id  = val1_id;
  end
  else if (val_in_2[7:0] > val_in_1[7:0]) begin
    val_out = val_in_2;
    out_id  = val2_id;
  end
