...
wire [6:0]  wire_addr;
wire [7:0] wire_reg_addr;
wire [31:0] wire_tx_data;
wire [31:0] wire_rx_data;
wire [15:0] wire_clk_div;
wire         wire_busy;
wire         wire_done;
wire         wire_error;
// Trace Interface Wires
//wire [7:0]  wire_trace_event;
//wire [31:0] wire_trace_data;
// Register File
i2c_register #(
...
i2c_master i2c (
    ...
    //.mode_sel(mode_sel),
     .mode_sel(control_reg_wire[2]),
    .clk_div (wire_clk_div),
    ...
    .ack_err        (wire_error),
    // Trace Interface
.trace_event_o (trace_event_o),
.trace_data_o  (trace_data_o)
);
//assign trace_event_o = wire_trace_event;
//assign trace_data_o  = wire_trace_data;
endmodule
