...
irq_ctrl #(	   
	   .MMR_IP_ADDR   (16'h9014), 
	   .MMR_IE_ADDR   (16'h9018),
	   .MMR_ATTR_ADDR (16'h901C),
	   .MMR_CTL_ADDR  (16'h9020),
	   .LVL_PR_VAL    (8'hff)
	  	)
irq_0_ctrl(
.soc_clk			(soc_clk			),
...
.global_int_enable_valid 	(EXCEPTION_ON	),
.soc_irq_ctrl_o			(irq0_ctrl_o			)
);

irq_ctrl #(
	   .MMR_IP_ADDR   (16'h9024), 
	   .MMR_IE_ADDR   (16'h9028),
	   .MMR_ATTR_ADDR (16'h902C),
	   .MMR_CTL_ADDR  (16'h9030),
	   .LVL_PR_VAL    (8'hff)
	  	)
irq_1_ctrl(
.soc_clk			(soc_clk			),
...
irq_ctrl #(	   
       .MMR_IP_ADDR   (16'h9034), 
	   .MMR_IE_ADDR   (16'h9038),
	   .MMR_ATTR_ADDR (16'h903C),
	   .MMR_CTL_ADDR  (16'h9040),
.LVL_PR_VAL    (8'hff) 
	  	)
irq_2_ctrl(
.soc_clk			(soc_clk			),
...
irq_ctrl #(	   
       .MMR_IP_ADDR   (16'h9044), 
	   .MMR_IE_ADDR   (16'h9048),
	   .MMR_ATTR_ADDR (16'h904C),
	   .MMR_CTL_ADDR  (16'h9050),	   
  .LVL_PR_VAL    (8'hff)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h9054), 
	   .MMR_IE_ADDR   (16'h9058),
	   .MMR_ATTR_ADDR (16'h905C),
	   .MMR_CTL_ADDR  (16'h9060),
	     .LVL_PR_VAL    (8'hff) 
	  	)
irq_4_ctrl(
.soc_clk			(soc_clk			),
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h9064), 
	   .MMR_IE_ADDR   (16'h9068),
	   .MMR_ATTR_ADDR (16'h906C),
	   .MMR_CTL_ADDR  (16'h9070),
	     .LVL_PR_VAL    (8'hff)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h9074), 
	   .MMR_IE_ADDR   (16'h9078),
	   .MMR_ATTR_ADDR (16'h907C),
	   .MMR_CTL_ADDR  (16'h9080),
	     .LVL_PR_VAL    (8'hff)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h9084), 
	   .MMR_IE_ADDR   (16'h9088),
	   .MMR_ATTR_ADDR (16'h908C),
	   .MMR_CTL_ADDR  (16'h9090),
	     .LVL_PR_VAL    (8'hff)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h9094), 
	   .MMR_IE_ADDR   (16'h9098),
	   .MMR_ATTR_ADDR (16'h909C),
	   .MMR_CTL_ADDR  (16'h90A0),
	     .LVL_PR_VAL    (8'hff)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h90A4), 
	   .MMR_IE_ADDR   (16'h90A8),
	   .MMR_ATTR_ADDR (16'h90AC),
	   .MMR_CTL_ADDR  (16'h90B0),
	    .LVL_PR_VAL    (8'hff)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h90B4), 
	   .MMR_IE_ADDR   (16'h90B8),
	   .MMR_ATTR_ADDR (16'h90BC),
	   .MMR_CTL_ADDR  (16'h90C0),
	   .LVL_PR_VAL    (8'hd3)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h90C4), 
	   .MMR_IE_ADDR   (16'h90C8),
	   .MMR_ATTR_ADDR (16'h90CC),
	   .MMR_CTL_ADDR  (16'h90D0),
	    .LVL_PR_VAL    (8'hcf)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h90D4), 
	   .MMR_IE_ADDR   (16'h90D8),
	   .MMR_ATTR_ADDR (16'h90DC),
	   .MMR_CTL_ADDR  (16'h90E0),
	   .LVL_PR_VAL    (8'hcb)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h90E4), 
	   .MMR_IE_ADDR   (16'h90E8),
	   .MMR_ATTR_ADDR (16'h90EC),
	   .MMR_CTL_ADDR  (16'h90F0),
	   .LVL_PR_VAL    (8'hc7)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h90F4), 
	   .MMR_IE_ADDR   (16'h90F8),
	   .MMR_ATTR_ADDR (16'h90FC),
	   .MMR_CTL_ADDR  (16'h9100),
	   .LVL_PR_VAL    (8'hbf)
...
irq_ctrl #(
	   .MMR_IP_ADDR   (16'h9104), 
	   .MMR_IE_ADDR   (16'h9108),
	   .MMR_ATTR_ADDR (16'h910C),
	   .MMR_CTL_ADDR  (16'h9110),
	   .LVL_PR_VAL    (8'hbb)
