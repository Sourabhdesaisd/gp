...
input  [DATA_WIDTH-1:0] satp_i 		, //Supervisor Address Translation and Protection
...
input [DATA_WIDTH-1:0] int_active_level_priority_i,
...
//input [DATA_WIDTH-1:0] uart_reset_csr_i ,
...
//		12'h303 :  dbg_mode_read_data_r = mideleg_i		;
    ...
    //    12'h33F :  dbg_mode_read_data_r =   mhpm_event31_i;      
	    12'hfc0 :  dbg_mode_read_data_r =   int_active_level_priority_i;//mintstatus
     //   12'hbc0 :  dbg_mode_read_data_r =   zic_base_addr_i  ;//zic base addr registers
	  //  12'hfc1 :  dbg_mode_read_data_r =   data_mem_max_addr_i;	
        ...
        12'h7b1 :  dbg_mode_read_data_r =   dpc_i;
        12'h180 :  dbg_mode_read_data_r =   satp_i;
...
//		12'h303 :csr_reg_read_data_r  = mideleg_i		;
    ...
    //    12'h33F :  csr_reg_read_data_r =   mhpm_event31_i;      
	    12'hfc0 :  csr_reg_read_data_r =   int_active_level_priority_i;//mintstatus
	...
	//    12'hfc1 :  csr_reg_read_data_r =   data_mem_max_addr_i;	
        ...
        12'h7b1 :  csr_reg_read_data_r =   dpc_i;
        12'h180 :  csr_reg_read_data_r =   satp_i;
        	//12'h7C0 : dbg_mode_read_data_r =  uart_reset_csr_i;
